...
export const INSTITUTION_TYPES: readonly InstitutionType[] = [
  ...
  },
  {
    ...
    countryExamples: [
      {
        countrySlug: 'france',
        note: 'France distributes network policing across national bodies rather than concentrating it in a single transport force, so the British model of one consolidated national transport force should not be read as the standard arrangement.',
      },
    ],
    relatedProfessions: ['patrol-officer'],
    relatedInstitutions: ['national-police', 'municipal-police'],
    ...
    sources: ['tna-police-records', 'unodc-cpcj'],
    status: 'published',
    review: 'fact-checked',
    updatedOn: '2026-08-10',
    reviewedOn: '2026-08-10',
