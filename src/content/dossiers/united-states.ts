...
export const UNITED_STATES: CountryDossier = {
  ...
  modules: [
    ...
    },
    {
      ...
      title: 'Police recruitment in the United States',
      summary:
        'There is no national police recruitment, no national entry requirement and no national academy. What can be established is the shape of the fragmentation, and one federal survey measures it.',
      status: 'published',
      review: 'fact-checked',
      safetyReview: 'cleared',
      ...
      blocks: [
        {
          ...
          text: 'This page explains the STRUCTURE of United States police recruitment. It states NO entry requirement, because no national requirement was established and no single employer speaks for the country. Verified on 6 September 2026.',
        },
        {
          kind: 'paragraph',
          text: 'Policing in the United States is carried out by a large number of separate employers at municipal, county, state and federal level. Each hires on its own terms. There is no national recruiter, and asking for "the US police requirements" asks for something that does not exist.',
          claim: 'analysis',
        },
        {
          kind: 'callout',
          variant: 'analysis',
          title: 'The most common error, and why it is easy to make',
          text: 'A single department publishes its requirements clearly, and those requirements then circulate as though they were national. They are one employer\u2019s. A page that repeated them under a United States heading would be describing one city and labelling it a country.',
        },
        {
          kind: 'paragraph',
          text: 'The federal survey of training academies shows the fragmentation in measurable form. The Bureau of Justice Statistics 2022 census found academies operated both by law enforcement agencies and by colleges and technical schools, and recorded an average of 806 hours of core basic training — with averages ranging by academy type from 681 hours at state POST or equivalent academies to 969 at state police and highway patrol academies, 734 at sheriff\u2019s office academies and 759 at academies run by two-year colleges.',
          claim: 'fact',
          sources: ['us-bjs-training-academies-2022'],
        },
        {
          kind: 'callout',
          variant: 'analysis',
          title: 'Read that as a recruitment fact, not a training fact',
          text: 'A range from 681 to 969 hours by academy type is what a decentralised system looks like from the inside. Different employers send recruits to differently governed academies of different lengths, which is why a national entry standard could not be stated even if someone wanted to.',
        },
        {
          kind: 'paragraph',
          text: 'The same census records that 89.2% of academies reported mandatory field training after basic training for some or all recruits, averaging 503 hours — so in most cases formal instruction is followed by a further supervised period before a recruit works independently.',
          claim: 'fact',
          sources: ['us-bjs-training-academies-2022'],
        },
        {
          ...
          text: 'Minimum selection standards in the United States are commonly described as being set by each state\u2019s standards body and by each employing agency. This platform could not verify that against a current official source: the California standards body\u2019s site refused connections during research, and the only federal material located on the subject was decades old and was not used. No entry requirement therefore appears on this page.',
        },
        {
          kind: 'callout',
          variant: 'safety',
          title: 'What this page will not tell you',
          text: 'It states no age, education, citizenship, medical or fitness requirement for any United States employer, and it cannot tell any individual whether they are eligible anywhere.',
        },
        {
          kind: 'callout',
          variant: 'note',
      ...
      uncertainty: [
        'NO United States entry requirement is stated anywhere on this page, because none was established from a current official source.',
        'The role of state standards bodies in setting minimum requirements could NOT be verified: post.ca.gov refused connections, and located federal material on the subject dated from the 1970s and was rejected as a source.',
        'Federal law-enforcement recruitment was NOT RESEARCHED and is not described.',
        'The BJS figures describe state and local training academies in 2022 and establish nothing about any individual employer\u2019s hiring requirements.',
      ],
    },
    {
      moduleId: 'history',
